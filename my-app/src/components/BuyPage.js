...
const BuyPage = ({ addInCart }) => {
    ...
    const addItem = async () => {
        ...
        const api = "http://localhost:5000/api/product/getproductdata";
      //const api = "https://www.elearningquran.com/api/GetMeetingDetails.aspx";
        // const api = "http://localhost:55453/api/faculty/getnisaabclassmasoolstudentsTesting";
        ...
        const allProducts = response.data.photos.map((val) => ({

            smallImage: val.src.medium,
            tinyImage: val.src.tiny,
                        ...
                        produts.map((val, ind) => {
                            return (
                                ...
                                <>
                                    ...
                                    <Col lg={4} sm={6} key={val.id} >

                                        <CartItem addInCart={addInCart} product={val} ></CartItem>
